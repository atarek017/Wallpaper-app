...
class ErrorHandler implements Exception {
  ...
  ErrorHandler.handle(dynamic error) {
    if (error is DioError) {
      ...
      // failure.body = error.response.toString();
    } else {
      // default error
...
class ResponseCode {
  ...
  static const int VALIDATION_ERROR = 422; // failure, 422 Unprocessable Content
  static const int TOO_MANY_REQUESTS = 429; // failure, not found
  ...
  static const int PATIENT_NOT_EXIST = -8;
}
...
class ResponseMessage {
  ...
  static const String TOO_MANY_REQUESTS =
      "Your going too fast, please take your time"; //
  static const String VALIDATION_ERROR = "Validation Error, Enter valid inputs";
